        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-foreground">
                Hi, I'm <span className="text-primary">Khawaja Aman Ali</span>
              </h1>
              <p className="text-xl text-muted-foreground leading-relaxed">
                I build AI-powered web applications — from LLM chatbots to end-to-end deployed products. 
                I turn complex AI capabilities into seamless, user-friendly experiences.
              </p>
            </div>
          ...
          <div className="flex justify-center">
            <div className="relative w-64 h-64 md:w-80 md:h-80">
              ...
              <Image
                src="/profile.jpg"
                alt="Khawaja Aman Ali - AI Engineer"
                fill
